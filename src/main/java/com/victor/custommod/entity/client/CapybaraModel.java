...
public class CapybaraModel extends EntityModel<CapybaraRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -5.0F, -9.0F, 10.0F, 10.0F, 18.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -11.0F, 0.0F));
